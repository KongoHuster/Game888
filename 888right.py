...
url = "curl 'https://bbin-tw.pragmaticplay.net/gs2c/v3/gameService' -H 'Referer: " \
      "https://bbin-tw.pragmaticplay.net/gs2c/html5Game.do?jackpotid=0&gname=888%20Dragons&extGame=1&ext=0&cb_target" \
      "=exist_tab&symbol=vs1dragon8&jurisdictionID=99&mgckey=AUTHTOKEN" \
      "@936a035a0181aff4221d6b85140b6a3804bb9bc7ce7d606e76c0b16460843c75~stylename@bbin~SESSION@488be1ea-6e25-4bd2" \
      "-8339-593f18e85468&tabName=' -H 'Origin: https://bbin-tw.pragmaticplay.net' -H 'User-Agent: Mozilla/5.0 (" \
      "Macintosh; Intel Mac OS X 10_13_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/72.0.3626.119 Safari/537.36' " \
      "-H 'Content-type: application/x-www-form-urlencoded' --data " \
      "'action=doSpin&symbol=vs1dragon8&c=1&l=1&index=6&counter=11&repeat=0&mgckey=AUTHTOKEN" \
      "@936a035a0181aff4221d6b85140b6a3804bb9bc7ce7d606e76c0b16460843c75~stylename@bbin~SESSION@488be1ea-6e25-4bd2" \
      "-8339-593f18e85468' --compressed "
